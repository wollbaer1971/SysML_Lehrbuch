...
Simulationstests erlauben viele Tests ohne echte Hardware. Sie ersetzen reale Tests nicht vollständig, sind aber für frühe Entwicklung sehr wertvoll.
...
Ein gutes Testmodell macht auch Lücken sichtbar. Wenn eine Anforderung keinen Testfall besitzt, ist das nicht automatisch falsch, aber es ist eine offene Frage. Vielleicht wird sie durch Analyse, Review oder Inspektion nachgewiesen. Auch das sollte dokumentiert werden.
