...
Abbildung~\ref{fig:kap16-mapping-sysml-ros2} stellt dieses 1:1-Mapping grafisch dar.

\begin{figure}[H]
  \centering
  \input{figures/fig_kap16_mapping_sysml_ros2}
  \caption{Grafische Darstellung des 1:1-Mappings zwischen SysML-v2-Part-Definitions und den zugehörigen ROS2-Nodes.}
