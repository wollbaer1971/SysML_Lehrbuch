...
\section{Erweiterung}
Wer weitergehen möchte, kann eine einfache ROS2-Simulation ergänzen. Möglich sind ein simulierter Batterieknoten, ein Statusknoten und ein Dummy-Object-Detector. Wichtig ist, dass die Umsetzung auf das Modell zurückgeführt wird.
...
Wenn Anforderungen, Blöcke und Tests nicht verbunden sind, bleibt das Projekt eine Sammlung einzelner Diagramme.
...
Prüfen Sie Ihr Modell: Gibt es Anforderungen ohne Test? Blöcke ohne Zweck? Schnittstellen ohne Datentyp? Notieren Sie mindestens fünf Verbesserungen.
\end{uebungbox}
