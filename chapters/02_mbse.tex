...
\subsection{Struktur}
Die Struktur beschreibt, aus welchen Hauptteilen das System besteht. In SysML werden dafür später Systemteile mit \texttt{part def} definiert. Für den Einstieg kann man an Teilsysteme denken:
...
Dann wird überlegt, welche Systemelemente die Funktionen realisieren. Hier entstehen erste Systemteile (\texttt{part def}), Teilsysteme oder Komponenten. Beim Roboter sind das zum Beispiel Sensorik, Navigation, Energieversorgung und Bedienung.
