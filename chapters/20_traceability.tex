...
\section{Einleitung}
\gls{traceability} bedeutet Nachvollziehbarkeit. Sie zeigt, wie Artefakte zusammenhängen. Bei MBSE ist das einer der größten praktischen Vorteile: Anforderungen, Funktionen, Blöcke, Schnittstellen, ROS2-Nodes und Tests bleiben verbunden.
...
Traceability ist ein Kernthema von MBSE und Requirements Engineering. SysML bietet dafür Beziehungen wie \texttt{satisfy}, \texttt{verify}, \texttt{deriveReqt} und \texttt{trace} \cite{friedenthal2014}.
