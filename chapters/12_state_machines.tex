...
\section{Beispiel}
\begin{verbatim}
Idle --GoalReceived--> Navigating
Navigating --ObstacleDetected--> AvoidingObstacle
AvoidingObstacle --PathFree--> Navigating
Navigating --BatteryLow--> ReturnToDock
ReturnToDock --DockReached--> Charging
Charging --ChargingComplete--> Idle
Navigating --ErrorDetected--> Error
Error --Reset--> Idle
\end{verbatim}
