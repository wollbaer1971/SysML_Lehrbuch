...
Erstellen Sie im Paket \texttt{02\_Requirements} ein Requirement Diagram. Legen Sie Anforderungen als SysML-Requirement-Elemente an. Tragen Sie ID und Text ein. Achten Sie darauf, dass die ID nicht nur im Namen, sondern auch als Eigenschaft gepflegt wird.
