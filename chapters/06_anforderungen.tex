...
In SysML v2 werden Anforderungen textuell mit dem Schlüsselwort \texttt{requirement} definiert:
...
Nutzen Sie Beschreibungsfelder (\texttt{doc /* ... */}), um Annahmen, Begründungen oder offene Fragen zu dokumentieren. Wenn eine Anforderung noch unklar ist, markieren Sie sie bewusst, statt sie stillschweigend als fertig zu behandeln.
